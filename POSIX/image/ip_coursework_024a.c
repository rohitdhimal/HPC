...
void detect_edges(unsigned char *in, unsigned char *out, rd_thread *args) {
  int i;
...
int main(int argc, char **argv) {
  ...
  rd_thread R1_arguments;
  R1_arguments.start = 0;
  R1_arguments.stride = 4;

rd_thread R2_arguments;
  R2_arguments.start = 1;
  R2_arguments.stride = 4;

rd_thread R3_arguments;
  R3_arguments.start = 2;
  R3_arguments.stride = 4;

rd_thread R4_arguments;
  R4_arguments.start = 3;
  R4_arguments.stride = 4;

pthread_create(&R1, NULL, detect, &R1_arguments);
pthread_create(&R2, NULL, detect, &R2_arguments);
pthread_create(&R3, NULL, detect, &R3_arguments);
pthread_create(&R4, NULL, detect, &R4_arguments);
